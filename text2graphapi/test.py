...
def read_dataset(dataset, file):
    ...
    #data = '/002/usuarios/andric.valdez/andric/datasets/pan20/train_large.jsonl'
    data = '/002/usuarios/andric.valdez/andric/projects/text2graph-API/text2graphapi/datasets/pan22/pan22-authorship-verification-training.jsonl'
...
def text_to_hetero_graph(corpus_docs):
    ...
    print("hetero graph config: ", vars(hetero_graph))
    print(vars(hetero_graph.prep))
...
def text_to_isg_graph(corpus_docs):
    ...
    # apply Heterogeneous transformation
    print("isg graph config: ", vars(isg))
    print(vars(isg.prep))
...
def main():
    ...
    if INPUT_CORPUS_TEST['active'] == True:
        ...
        train = read_dataset(DATASET, file='train_large.jsonl')
